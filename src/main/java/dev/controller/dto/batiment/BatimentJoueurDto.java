...
public class BatimentJoueurDto {
	...
	public BatimentJoueurDto(Integer id, Joueur joueur, Batiment batiment, Integer niveau,
			Integer ouvrierNecessaireAmelioration, Integer tempsAmelioration, Long coutPierreAmelioration,
			Long coutBoisAmelioration, Long coutOreAmelioration, Long coutNourritureAmelioration,

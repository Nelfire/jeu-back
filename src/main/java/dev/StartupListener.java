...
//		this.batimentJoueurRepo.save(batimentJoueur4);
        ...
        CampagneArmee campagneArmeeUne = new CampagneArmee();
        campagneArmeeUne.setUnite(archer);
        campagneArmeeUne.setQuantite(5);
        
        CampagneArmee campagneArmeeDeux = new CampagneArmee();
        campagneArmeeDeux.setUnite(villageois);
        campagneArmeeDeux.setQuantite(12);

        this.campagneArmeeRepo.save(campagneArmeeUne);
        this.campagneArmeeRepo.save(campagneArmeeDeux);
        
        List<CampagneArmee> listeArmee = new ArrayList<>();
        listeArmee.add(campagneArmeeUne);
        listeArmee.add(campagneArmeeDeux);
        ...
        campagneUne.setCampagneArmee(listeArmee);
        campagneUne.setIsBoss(false);
        campagneUne.setRecompensePierre(500L);
        campagneUne.setRecompenseBois(500L);
        campagneUne.setRecompenseOr(500L);
        campagneUne.setRecompenseNourriture(50L);

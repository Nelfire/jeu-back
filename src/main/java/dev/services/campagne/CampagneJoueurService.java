...
public class CampagneJoueurService {
	...
	public CampagneJoueurService(CampagneJoueurRepo campagneJoueurRepo, ArmeeRepo armeeRepo, JoueurService joueurService, JoueurRepo joueurRepo, CampagneRepo campagneRepo, CampagneUniteeRepo campagneUniteeRepo, UniteeRepo uniteeRepo) {
		super();
	...
	public List<CampagneJoueur> listerCampagneJoueur() {
		...
		for (CampagneJoueur campagne : campagneJoueurRepo.findByJoueur(jou)) {
			...
			if(campagne.getDateFinCampagne()< maintenant && campagne.getEtatCampagne()==0) {
				// DÉFINIR L'ÉTAT DE RÉUSSITE OU DE DÉFAITE DE LA CAMPAGNE EN FONCTION DU POURCENTAGE DE RÉUSSITE
	...
	public CampagneJoueur rechercherCampagneJoueurById(Integer id) {
		// Recherche de l'campagne joueur correspondante
	...
	public CompositionArmeeCampagneDto envoiUniteeEnCampagne(CompositionArmeeCampagneDto compositionArmeeCampagne) {
		...
		// RÉCUPÉRATION DU JOUEUR
		Joueur jou = joueurService.recuperationJoueur();
		// RECHERCHE CAMPAGNE CORRESPONDANTE
		...
		// Vérification niveau campagne lancée pas supérieure au niveau maximum de campagne débloqué par le joueur
		...
		// RETRAIT UNITEES
		// - Parcourir les armées que possède déjà le joueur, pour y soustraire les unitées qu'il envoi en campagne
		for (Armee arme : armeeRepo.findByJoueur(jou)) {
			if(arme.getUnitee().getId()==1) // Villageois
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreVillageois()<0) {
					...
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreVillageois());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreVillageois());
			...
			else if(arme.getUnitee().getId()==2)  // Archer
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreArcher()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreArcher());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreArcher());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==3)  // ArcherComposite
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreArcherComposite()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreArcherComposite());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreArcherComposite());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==4)  // FantassinEpee
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreFantassinEpee()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreFantassinEpee());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreFantassinEpee());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==5)  // nombrePiquier
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombrePiquier()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombrePiquier());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombrePiquier());
					campagneUniteeRepo.save(campagneUnitee);
				}
			}
			else if(arme.getUnitee().getId()==6)  // nombreLanceurDeHache
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreLanceurDeHache()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreLanceurDeHache());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreLanceurDeHache());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==7)  // nombreMilicien
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreMilicien()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreMilicien());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreMilicien());
					campagneUniteeRepo.save(campagneUnitee);
				}
			}
			else if(arme.getUnitee().getId()==8)  // nombreHommeDArme
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreHommeDArme()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreHommeDArme());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreHommeDArme());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==9)  // nombreCavalierArcher
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreCavalierArcher()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreCavalierArcher());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreCavalierArcher());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==10)  // nombreCavalier
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreCavalier()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreCavalier());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreCavalier());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==11)  // nombreChampion
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreChampion()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreChampion());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreChampion());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==12)  // nombreBateauDePeche
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreBateauDePeche()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreBateauDePeche());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreBateauDePeche());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==13)  // nombreBateauIncendiaire
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreBateauIncendiaire()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreBateauIncendiaire());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreBateauIncendiaire());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==14)  // nombreBateauDeDestruction
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreBateauDeDestruction()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreBateauDeDestruction());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreBateauDeDestruction());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==15)  // nombreGalionACanon
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreGalionACanon()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreGalionACanon());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreGalionACanon());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==16)  // nombreGalion
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreGalion()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreGalion());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreGalion());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==17)  // nombreGuerrierElite
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreGuerrierElite()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreGuerrierElite());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreGuerrierElite());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==18)  // nombrePhalange
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombrePhalange()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombrePhalange());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombrePhalange());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==19)  // nombreSamourail
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreSamourail()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreSamourail());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreSamourail());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==20)  // nombreTemplier
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreTemplier()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreTemplier());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreTemplier());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==21)  // nombreCatapulte
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreCatapulte()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreCatapulte());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreCatapulte());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==22)  // nombreElephantDeCombat
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombreElephantDeCombat()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombreElephantDeCombat());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombreElephantDeCombat());
					campagneUniteeRepo.save(campagneUnitee);
				}
			} 
			else if(arme.getUnitee().getId()==23)  // nombrePretre
			{
				if(arme.getQuantitee()-compositionArmeeCampagne.getNombrePretre()<0) {
					...
					// - Calcul des dégats émis
					degatsEmis = degatsEmis + (arme.getUnitee().getAttaque() * compositionArmeeCampagne.getNombrePretre());
					armee.setId(arme.getId());
					armee.setJoueur(jou);
					armee.setUnitee(arme.getUnitee());
					...
					CampagneUnitee campagneUnitee = new CampagneUnitee(campagne.getId(),arme.getUnitee().getId(),compositionArmeeCampagne.getNombrePretre());
					campagneUniteeRepo.save(campagneUnitee);
				}
			}
	    ...
	    int pourcentageReussite = 100 - (((vieRestanteCampagne * 100) / (campagne.getUnitee().getVie()*campagne.getQuantitee())));
	    if (vieRestanteCampagne < 0) {
	      pourcentageReussite = 100;
	    }
	    
	    
		// CRÉATION DE L'CAMPAGNE JOUEUR
		CampagneJoueur campagneJoueur = new CampagneJoueur();
	...
	public CampagneJoueur recupererRecompense(Integer idCampagne) {
			...
			// DANS LE CAS OU LA CAMPAGNE EST UN SUCCES, ATTIBUTION DES RESSOURCES AU JOUEUR (PIERRE, BOIS, OR, NOURRITURE, GEMME)
		    if (campJoueur.getEtatCampagne() == 1) 
		    {
				...
				jou.setNourriturePossession(jou.getNourriturePossession() + campJoueur.getCampagne().getRecompenseNourriture());

package dev.entites.batiment.stockage;
...
public class Grenier {
    ...
    /** espace de stockage disponnible **/
    private Integer montantStockageDisponnible;
	...
	/**
	 * @return Retourne l'espace de stockage disponnible du bâtiment
	 */
	public Integer getMontantStockageDisponnible() {
		return (this.niveau*this.niveau)*(70000*this.niveau);
	}

	/**
	 * @return Défini l'espace de stockage disponnible du bâtiment
	 */
	public void setMontantStockageDisponnible(Integer montantStockageDisponnible) {
		this.montantStockageDisponnible = montantStockageDisponnible;
	}

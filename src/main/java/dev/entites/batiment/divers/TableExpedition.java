...
public class TableExpedition {
     ...
     * 18 = TableExpedition,
     *  **/
    private final Integer idTypeBatiment = 18;
    
    /** icone du batiment **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom du batiment **/
    private final String libelle = "Table d'Expedition";
    
    /** descriptif du batiment **/
    private final String descriptif = "Le descriptif de la Table d'Expedition";
	 ...
	 * @param niveau
	 */
	public TableExpedition(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	/**

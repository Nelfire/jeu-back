...
@Entity
public class CaserneMillitaire {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id;
    /** type de batiment : 
     * 11 = CaserneMillitaire,
     *  **/
    private final Integer idTypeBatiment = 11;
    
    /** icone du batiment **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom du batiment **/
    private final String libelle = "Caserne Millitaire";
    
    /** descriptif du batiment **/
    private final String descriptif = "Le descriptif de la Caserne Millitaire";
	 ...
	 * @param niveau
	 */
	public CaserneMillitaire(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	/**

...
public class AtelierDeSiege {
     ...
     * 14 = AtelierDeSiege,
     *  **/
    private final Integer idTypeBatiment = 14;
    
    /** icone du batiment **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom du batiment **/
    private final String libelle = "Atelier de Siege";
    
    /** descriptif du batiment **/
    private final String descriptif = "Le descriptif de l'Atelier de Siège";
	 ...
	 * @param niveau
	 */
	public AtelierDeSiege(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	/**

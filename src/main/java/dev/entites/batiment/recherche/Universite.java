package dev.entites.batiment.recherche;
...
public class Universite {
     ...
     * 16 = Universite,
     *  **/
    private final Integer idTypeBatiment = 16;
    
    /** icone du batiment **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom du batiment **/
    private final String libelle = "Universite";
    
    /** descriptif du batiment **/
    private final String descriptif = "Le descriptif de l'Universite";
	 ...
	 * @param niveau
	 */
	public Universite(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	/**

package dev.entites.batiment.ressource;
...
public class CampDeBucheron {
     ...
     * 4 = CampDeBucheron,
     *  **/
    private final Integer idTypeBatiment = 4;
    
    /** icone du batiment **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom du batiment **/
    private final String libelle = "Camp de Bucheron";
    
    /** descriptif du batiment **/
    private final String descriptif = "Le descriptif du Camp de Bucheron";
    ...
    /** nombre d'exploitants autorisés pour le farm de ressources dans le bâtiment**/
    private Integer exploitantsAutorises;
    
    /** nombre d'exploitants actuel pour le farm de ressources dans le bâtiment**/
    private Integer exploitantsActuel;
    
    /** apport de ressource par heure**/
    private Integer apportRessourceParHeure;
    
	/**
	 * Constructeur vide
	 */
	public CampDeBucheron() {
	 ...
	 * @param niveau
	 */
	public CampDeBucheron(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	/**
	...
	/**
	 * @return Retourne le montant de ressources rapportée par le bâtiment chaques heures
	 */
	public Integer getApportRessourceParHeure() {
		return ((this.niveau * 2000)*this.niveau)*((100*1)/this.exploitantsActuel);
	}

	/**
	 * @return Défini le montant de ressources rapportée par le bâtiment chaques heures
	 */
	public void setApportRessourceParHeure(Integer apportRessourceParHeure) {
		this.apportRessourceParHeure = apportRessourceParHeure;
	}

	/**
	 * @return Retourne le nombre d'exploitants autorisé pour le farm de ressource pour le bâtiment
	 */
	public Integer getExploitantsAutorises() {
		return exploitantsAutorises;
	}

	/**
	 * @return Défini le nombre d'exploitants autorisé pour le farm de ressource pour le bâtiment
	 */
	public void setExploitantsAutorises(Integer exploitantsAutorises) {
		this.exploitantsAutorises = exploitantsAutorises;
	}

	/**
	 * @return Retourne le nombre d'exploitants actuel pour le farm de ressource pour le bâtiment
	 */
	public Integer getExploitantsActuel() {
		return exploitantsActuel;
	}

	/**
	 * @return Defini le nombre d'exploitants actuel pour le farm de ressource pour le bâtiment
	 */
	public void setExploitantsActuel(Integer exploitantsActuel) {
		this.exploitantsActuel = exploitantsActuel;
	}

...
public class Carriere {
     ...
     * 3 = Carriere,
     *  **/
    private final Integer idTypeBatiment = 3;
    
    /** icone du batiment **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom du batiment **/
    private final String libelle = "Carrière";
    
    /** descriptif du batiment **/
    private final String descriptif = "Le descriptif de la Carrière";
	 ...
	 * @param niveau
	 */
	public Carriere(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	/**

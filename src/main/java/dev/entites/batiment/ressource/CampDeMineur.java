...
public class CampDeMineur {
     ...
     * 5 = CampDeMineur,
     *  **/
    private final Integer idTypeBatiment = 5;
    
    /** icone du batiment **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom du batiment **/
    private final String libelle = "Camp de Mineur";
    
    /** descriptif du batiment **/
    private final String descriptif = "Le descriptif du Camp de Mineur";
	 ...
	 * @param niveau
	 */
	public CampDeMineur(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	/**

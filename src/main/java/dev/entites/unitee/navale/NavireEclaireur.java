...
public class NavireEclaireur {
     ...
     * 12 = NavireEclaireur
     *  **/
    private final Integer idUnitee = 12;
    ...
    /** nom de l'unitée **/
    private final String libelle = "Navire Eclaireur";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif du Navire Eclaireur";
	 ...
	 * @param niveau
	 */
	public NavireEclaireur(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (NavireEclaireur = 12)
	 */

...
public class NavireDePeche {
     ...
     * 11 = NavireDePeche
     *  **/
    private final Integer idUnitee = 11;
    ...
    /** nom de l'unitée **/
    private final String libelle = "Navire de Peche";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif du Navire de Peche";
	 ...
	 * @param niveau
	 */
	public NavireDePeche(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (NavireDePeche = 11)
	 */

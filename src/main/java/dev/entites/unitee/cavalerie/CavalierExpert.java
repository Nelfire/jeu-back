package dev.entites.unitee.cavalerie;
...
public class CavalierExpert {
     ...
     * 9 = CavalierExpert
     *  **/
    private final Integer idUnitee = 9;
    
    /** id batiment provenance : 
     * 12 = Ecurie,
     *  **/
    private final Integer idBatimentProvenance = 12;
    
    /** icone de l'unitée **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom de l'unitée **/
    private final String libelle = "Cavalier Expert";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif du Cavalier Expert";
	 ...
	 * @param niveau
	 */
	public CavalierExpert(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (CavalierExpert = 9)
	 */

...
public class Cavalier {
     ...
     * 8 = Cavalier
     *  **/
    private final Integer idUnitee = 8;
    ...
    /** nom de l'unitée **/
    private final String libelle = "Cavalier";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif du Cavalier";
	 ...
	 * @param niveau
	 */
	public Cavalier(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (Cavalier = 8)
	 */

package dev.entites.unitee.siege;
...
public class ElephanDeGuerre {
     ...
     * 16 = ElephanDeGuerre
     *  **/
    private final Integer idUnitee = 16;
    
    /** id batiment provenance : 
     * 14 = Atelier de Siège,
     *  **/
    private final Integer idBatimentProvenance = 14;
    
    /** icone de l'unitée **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom de l'unitée **/
    private final String libelle = "Elephan de Guerre";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif de la Elephan de Guerre";
	 ...
	 * @param niveau
	 */
	public ElephanDeGuerre(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (ElephanDeGuerre = 16)
	 */

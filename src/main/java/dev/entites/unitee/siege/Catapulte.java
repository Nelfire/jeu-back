...
public class Catapulte {
     ...
     * 14 = Catapulte
     *  **/
    private final Integer idUnitee = 14;
    ...
    /** nom de l'unitée **/
    private final String libelle = "Catapulte";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif de la Catapulte";
	 ...
	 * @param niveau
	 */
	public Catapulte(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (Catapulte = 14)
	 */

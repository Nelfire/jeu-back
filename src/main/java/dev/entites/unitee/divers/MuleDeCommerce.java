...
public class MuleDeCommerce {
     ...
     * 17 = MuleDeCommerce
     *  **/
    private final Integer idUnitee = 17;
    
    /** id batiment provenance : 
     * 17 = Marché,
     *  **/
    private final Integer idBatimentProvenance = 17;
    
    /** icone de l'unitée **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom de l'unitée **/
    private final String libelle = "Mule de Commerce";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif de la Mule de Commerce";
	 ...
	 * @param niveau
	 */
	public MuleDeCommerce(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (MuleDeCommerce = 17)
	 */

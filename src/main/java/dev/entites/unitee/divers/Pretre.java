...
public class Pretre {
     ...
     * 18 = Pretre
     *  **/
    private final Integer idUnitee = 18;
    
    /** id batiment provenance : 
     * 16 = Université,
     *  **/
    private final Integer idBatimentProvenance = 16;
    
    /** icone de l'unitée **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom de l'unitée **/
    private final String libelle = "Prêtre";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif du Prêtre";
	...
	/**
	 * @return Retourne l'id du type unitée (Pretre = 18)
	 */

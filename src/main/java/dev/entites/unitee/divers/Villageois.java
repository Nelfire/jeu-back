package dev.entites.unitee.divers;
...
public class Villageois {
     ...
     * 1 = Villageois
     *  **/
    private final Integer idUnitee = 1;
    
    /** id batiment provenance : 
     * 1 = Hotel de ville,
     *  **/
    private final Integer idBatimentProvenance = 1;
    
    /** icone de l'unitée **/
    private final String icone = "https://marcdekeister.files.wordpress.com/2018/09/dessin-hocc82tel-de-ville-de-paris.jpg";
    
    /** nom de l'unitée **/
    private final String libelle = "Villageois";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif du Villageois";
    ...
    private Integer tempsFormation = 20;

    /** points de vie de l'unitée **/
    private Integer vie = 50;

    /** points d'attaque de l'unitée **/
    private Integer attaque = 1;
	 ...
	 * @param niveau
	 */
	public Villageois(Integer niveau) {
		super();
		this.niveau = niveau;
	}

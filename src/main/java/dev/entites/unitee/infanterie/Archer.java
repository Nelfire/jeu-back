...
public class Archer {
     ...
     * 5 = Archer
     *  **/
    private final Integer idUnitee = 5;
    ...
    /** nom de l'unitée **/
    private final String libelle = "Archer";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif de l'Archer";
    ...
    private final Integer coutOrFormation = 0;
    ...
    private Integer vie = 100;

    /** points d'attaque de l'unitée **/
    private Integer attaque = 10;

    /** portée de l'unitée **/
    private Integer portee = 4;
	...
	/**
	 * @return Retourne l'id du type unitée (Archer = 5)
	 */

...
public class FantassinHache {
     ...
     * 2 = Fantassin Hache
     *  **/
    private final Integer idUnitee = 2;
    ...
    /** nom de l'unitée **/
    private final String libelle = "Fantassin Hache";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif du Fantassin Hache";
	 ...
	 * @param niveau
	 */
	public FantassinHache(Integer niveau) {
		super();
		this.niveau = niveau;
	}

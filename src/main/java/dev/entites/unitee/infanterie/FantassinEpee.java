...
public class FantassinEpee {
     ...
     * 3 = Fantassin Epee
     *  **/
    private final Integer idUnitee = 3;
    ...
    /** nom de l'unitée **/
    private final String libelle = "Fantassin Epee";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif du Fantassin Epee";
    ...
    private final Integer coutBoisFormation = 0;
    ...
    private Integer tempsFormation = 40;

    /** points de vie de l'unitée **/
    private Integer vie = 70;

    /** points d'attaque de l'unitée **/
    private Integer attaque = 9;

    /** portée de l'unitée **/
    private Integer portee = 0;

    /** points d'armure de l'unitée **/
    private Integer armure = 1;
    
    /** niveau necessaire du bâtiment pour débloquer la formation **/
    private final Integer niveauBatimentNecessaireFormation = 2;

    
	/**
	 * Constructeur vide
	 */
	public FantassinEpee() {
	 ...
	 * @param niveau
	 */
	public FantassinEpee(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (FantassinEpee = 3)
	 */

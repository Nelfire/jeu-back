...
public class ArcherComposite {
     ...
     * 6 = ArcherComposite
     *  **/
    private final Integer idUnitee = 6;
    ...
    /** nom de l'unitée **/
    private final String libelle = "Archer Composite";
    
    /** descriptif de l'unitée **/
    private final String descriptif = "Le descriptif de l'Archer Composite";
    
    /** niveau de l'unitée **/
    private Integer niveau;
    
    /** coût en pierre de l'unitée **/
    private final Integer coutPierreFormation = 10;
    
    /** coût en bois de l'unitée **/
    private final Integer coutBoisFormation = 20;
    
    /** coût en or de l'unitée **/
    private final Integer coutOrFormation = 15;
    ...
    private Integer vie = 110;

    /** points d'attaque de l'unitée **/
    private Integer attaque = 12;

    /** portée de l'unitée **/
    private Integer portee = 5;

    /** points d'armure de l'unitée **/
    private Integer armure = 0;
    
    /** niveau necessaire du bâtiment pour débloquer la formation **/
    private final Integer niveauBatimentNecessaireFormation = 4;

    
	/**
	 * Constructeur vide
	 */
	public ArcherComposite() {
	 ...
	 * @param niveau
	 */
	public ArcherComposite(Integer niveau) {
		super();
		this.niveau = niveau;
	}
	...
	/**
	 * @return Retourne l'id du type unitée (ArcherComposite = 6)
	 */
